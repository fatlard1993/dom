...
var dom = {
	...
	onLoad: function(func){
		...
		document.addEventListener('touchstart', dom.interact.touchDown);
		document.addEventListener('mousedown', dom.interact.mouseDown);
		document.addEventListener('touchend', dom.interact.touchUp);
		document.addEventListener('touchcancel', dom.interact.touchUp);
		document.addEventListener('mouseup', dom.interact.mouseUp);
	...
	interact: {
		...
		mouseDown: function(evt){
			...
			dom.interact.triggerEvent('mouseDown', evt);

			dom.interact.pointerDown(evt);
		},
		mouseUp: function(evt){
			evt.pointerType = 'mouse';

			dom.interact.triggerEvent('mouseUp', evt);

			dom.interact.pointerUp(evt);
		},
		touchDown: function(evt){
			evt.pointerType = 'touch';

			dom.interact.triggerEvent('touchDown', evt);
		...
		touchUp: function(evt){
			...
			dom.interact.triggerEvent('touchUp', evt);
